...
class Liputan extends CI_Controller {
   ...
   function menu_json(){
        $this->datatables->select("m1.id_liputan id_liputan,m1.judul judul,m1.isi isi,m1.ringkasan ringkasan, m1.foto foto,m1.deskripsi_foto deskripsi_foto, m1.tgl_posting tgl_posting")
