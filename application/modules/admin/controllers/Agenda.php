...
class Agenda extends CI_Controller {
   ...
   public function detail($id=0){
	...
	function menu_json(){
        ...
        $this->datatables->select("m1.id_agenda id_agenda,m1.nama_agenda nama_agenda,m1.deskripsi deskripsi,m1.tempat tempat,m1.tgl_mulai tgl_mulai, m1.tgl_selesai tgl_selesai,m1.tgl_posting tgl_posting")
