							...
							<div class="col-md-12">
								...
								<div class="row col-md-12 mb-lg">
									<div class="post-meta pl-none" style="">
										...
										<span style="color:#ffffff" class="pull-right">Dilihat : <?php echo $b1->counter?> kali</span>
									</div>
								</div>
								<div class="row col-md-12 mb-lg">
										...
										<div class="featured-box featured-box-primary mt-xl" style="text-align:left">
											<div class="box-content">
												...
												<?php foreach($side as $s):?>
													<li>
														<div class="post-info">
															<a href="<?php echo site_url($lang.'/page/laboratorium/'.$s->id_lab);?>"><?php echo $s->nama_lab?></a>
														</div>
													</li>
												<?php endforeach ?>	
												<?php endif ?>
										...
										<div class="col-md-6 mr-none">
											<article class="post" style="text-align:justify">
												...
												<div class="post-meta pl-none">
													...
													<span class="pull-right">Dilihat : <?php echo $b2->counter?> kali</span>
												</div>
									...
									<div class="panel panel-default">
										...
										<div id="collapse<?php echo $a->id_agenda?>" class="accordion-body collapse">
											<div class="panel-body">
												...
												<?php echo nama_hari($a->tgl_mulai); if($a->tgl_selesai!=$a->tgl_mulai and $a->tgl_selesai!="0000-00-00") echo " s.d. ".nama_hari($a->tgl_selesai);?><br>
												<strong>Tanggal</strong><br>
												<?php echo tanggal_indonesia($a->tgl_mulai); if($a->tgl_selesai!=$a->tgl_mulai and $a->tgl_selesai!="0000-00-00") echo " s.d. ".tanggal_indonesia($a->tgl_selesai); ?><br>
												<strong>Jam</strong><br>
												<?php echo $jam_mulai; if($jam_selesai=="00:00:00"){ echo " s.d. 23:59:59";}else{echo " s.d. ".$jam_selesai;} ?> WIB <br>
