...
<div  class="article-content">
	...
	<div class="post-content">
			...
			<?php if(isset($ext) and $ext !=null){?>
				  <iframe width="100%" height="500" src="<?php echo base_url().'media/gambar/'.$d->nama_file ?>" ></iframe>  
				 <?php }else{ ?>
				...
				<div class="col-md-12">
					<div class="row mb-xl pull-right">
						<a class="btn btn-primary"  href="<?php echo site_url('web/pengumuman/download/'.$d->id_pengumuman.'/'.url_title(strtolower($d->nama_pengumuman))) ?>"><i class="fa fa-arrow-circle-o-down"></i> Download</a> 
					</div>
				</div>
	...
	<div class="mt-lg">
		<div class="col-md-6">
			...
			<?php foreach($rec as $r):?>
				<li><a href="<?php echo site_url($lang.'/pengumuman/detail/'.$r->id_pengumuman.'/'.url_title(strtolower($r->nama_pengumuman))) ?>"><i class="fa fa-caret-right"></i> <?php echo $r->nama_pengumuman?></a></li>
			<?php endforeach ?>
			</ul>				
		</div>
