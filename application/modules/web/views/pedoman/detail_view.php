...
<div  class="article-content">
	...
	<div class="post-content">
				<h2 class="mb-none"><a><?php echo $d->nama_dokumen?></a></h2>
				<div class="post-meta">
			...
			<?php if(isset($d) and $d !=null){?>
				...
				<div class="col-md-12">
					<div class="row mb-xl pull-right">
						<a class="btn btn-primary"  href="<?php echo site_url($lang.'/page/pedoman_akademik/'.$d->id_dokumen) ?>"><i class="fa fa-arrow-circle-o-down"></i> Download</a> 
					</div>
				</div>
